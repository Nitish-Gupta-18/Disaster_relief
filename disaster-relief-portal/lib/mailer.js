...
export async function sendAssignmentNotification(volunteer, request) {
...
export async function sendAssignmentStatusEmail(volunteer, request, newStatus, oldStatus) {
  const config = {
...
export async function sendUnassignedEmail(volunteer, request) {
...
export async function sendRequestStatusEmail(volunteer, request, newStatus) {
  const config = {
...
export async function sendProfileUpdateEmail(volunteer, changedFields) {
